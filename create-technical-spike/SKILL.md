...
Create individual files in `${input:FolderPath|docs/spikes}` directory. Name each file using the pattern: `[category]-[short-description]-spike.md` (e.g., `api-agent-integration-spike.md`, `performance-realtime-audio-spike.md`).
...
- `api-agent-chat-integration-spike.md`
...
- **fetch/repository:** Analyze external APIs, libraries, and examples
